...
1. `api.test.js` Contiene las assertions de la API

2. `.github/workflows/node_ci.yml` Configuración de la automatización en la nube

3. `.gitignore` Archivos excluidos del control de versiones (node_modules, .env, etc.).
